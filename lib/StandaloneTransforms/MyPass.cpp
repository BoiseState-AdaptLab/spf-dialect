...
public:
  ...
  void walkLeaf(omega::CG_leaf *leaf) {
    ...
    // produce loads from input memerefs
    ...
    // It appears that induction variables stay the same as the order of
    // constraints. This assumes that to be true. I hope it actually is.
