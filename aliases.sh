...
alias b="make -C build standalone-opt Runtime CUDARuntime jacobi-no-transform-c-print-example jacobi-transformed-c-print-example"
...
alias rss="build/bin/standalone-opt --my-pass --cse --debug-only=my-pass sparse_mttkrp_test.mlir"
alias rsp="build/bin/standalone-opt --my-pass --cse --debug-only=my-pass sparse_mttkrp_gpu_test.mlir"
